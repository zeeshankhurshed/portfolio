...
<div className={`${styles.flexCenter} flex-1 md:my-0 my-10 relative`}>
    ...
    <div className='absolute z-[0] w-[40%] h-[35%] top-0 pink_gradinet'></div>
    <div className='absolute z-[1] w-[80%] h-[8%] top-0 rounded-full bottom-0 white_gradinet'></div>
    <div className='absolute z-[0] w-[50%] h-[50%] right-20 bottom-20 blue_gradinet'></div>
      </div>
